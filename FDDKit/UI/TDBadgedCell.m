...
- (void) drawRect:(CGRect)rect
{
    ...
    CGSize numberSize;
    numberSize = [self.badgeString commonSizeWithFont:font];
    
    CGFloat radius = (__radius)?__radius:9.0;
	...
	CGRect bounds = CGRectMake((rect.size.width / 2) - (numberSize.width / 2) ,
                               ((rect.size.height / 2) - (numberSize.height / 2) -1),
...
- (void) layoutSubviews
{
	...
	if(self.badgeString)
	{
        ...
        CGSize badgeSize;
        badgeSize = [self.badgeString commonSizeWithFont:font];
